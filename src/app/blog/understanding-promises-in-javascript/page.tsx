  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A detailed guide to JavaScript Promises and asynchronous programming."
        />
        <meta
          name="keywords"
          content="JavaScript, Promises, Async, Await, Asynchronous Programming"
        />
        <meta name="author" content="Kumar Amrendram" />
        <meta
          property="og:title"
          content=" Understanding Promises in JavaScript"
        />
        <meta
          property="og:url"
          content={`https://www.amrendram.me/blog/understanding-promises-in-javascript`}
        />
      </Head>
      <section>
        <div className="p-8 min-h-screen max-w-4xl mx-auto">
          ...
          <div className="py-4">
            ...
            <p>
              ...
              asynchronous tasks efficiently using Promises and Async/Await.
              These concepts can be challenging for beginners, but understanding
              them is essential for writing modern JavaScript. In this guide,
              we&apos;ll break down these concepts in a way that makes them easy
          ...
          <div className="py-4">
            ...
            <p>
              ...
              future, or never. It&apos;s a way to handle asynchronous
              operations. When a Promise is successful, it’s called{" "}
              <strong>fulfilled</strong>; when it fails, it’s called{" "}
...
`}
            ...
            <div className="pb-4">
              ...
              <ol className="list-decimal list-inside space-y-1 mt-2">
                ...
                <li>
                  We handle the result using <code>.then()</code> for success
                  and <code>.catch()</code> for errors.
                </li>
              </ol>
            </div>
            ...
            <ol className="list-decimal list-inside space-y-3 mt-4">
              ...
              <li>
                <strong>Rejected:</strong>
                <span className="ml-1">
                  The operation failed, and the Promise now holds a reason for
                  the failure (error).
                </span>
              </li>
              <li>
                ...
                <span className="ml-1">
                  Settled is not a Promise state. It only indicates that a
                  Promise is either fulfilled or rejected and can no longer
                  change its state.
                </span>
              </li>
            </ol>
            ...
            <Terminology
              ...
              description={
                <p>
                  Promise result values are immutable; once a Promise is
                  resolved or rejected, its state and value cannot be changed.
                  In the above example, once the promise is resolved, the value
                  of <code>(const promise)</code> cannot be changed
                </p>
              }
            />
            <p className="mt-4">
              While you can&apos;t directly access a Promise&apos;s internal
              state (like checking if it&apos;s{" "}
              <strong>&quot;pending&quot;</strong> without handling it), you can
              use <code>.then()</code>, <code>.catch()</code>, and{" "}
              <code>.finally()</code> to handle each outcome:
            </p>
            ...
            <Terminology
              ...
              description={
                <p>
                  a Promise is a JavaScript object that represents the outcome
                  of an asynchronous operation. It can be in one of three
                  states: pending, fulfilled, or rejected. Promises are useful
                  for handling asynchronous tasks and help keep your code clean
                  and organized.
                </p>
              }
            />
          ...
          <div className="">
            ...
            <p className="mt-6">
              ...
              <strong>Promise APIs</strong>—that make it easier to manage
              multiple Promises and handle more complex asynchronous flows.
              These methods help us run Promises in parallel, wait for all of
              them to finish, or just pick the fastest one. Let&apos;s explore
              them one by one.
            </p>
            ...
            <div className="my-4">
              ...
              <ul className="list-inside mt-2 space-y-1">
                <li>
                  - Takes iterable(array) of Promises and returns a single
                ...
                <li>
                  - If all promises are resolved, the result is an array of
                  their results in the same order as the input promises
                </li>
                <li>
...
`}
            ...
            <div className="my-4">
              ...
              <ul className="list-inside mt-2 space-y-1">
                ...
                <li>
                  - Returns an array of objects, each representing the outcome
                  of each promise
                </li>
                <li>
...
`}
            ...
            <div className="my-4">
              ...
              <ul className="list-inside mt-2 space-y-1">
                ...
                <li>
                  - Useful when you want to get the result of the first
                  successful promise
                </li>
              </ul>
              <CodeBlock
...
`}
            ...
            <div className="my-4">
              ...
              <ul className="list-inside mt-2 space-y-1">
                ...
                <li>
                  - The result is the value or reason of the first settled
                  promise
                </li>
                <li>
                  - Useful when you want to get the result of the first promise
                  that settles, regardless of whether it was fulfilled or
                  rejected
                </li>
              </ul>
              <CodeBlock
  ...
  .catch((error) => {
    console.error("Error in promise:", error);
          ...
          <div className="">
            ...
            <p>
              Promises are key to handling asynchronous operations in
              JavaScript. By understanding their states and using APIs like{" "}
              <code>Promise.all()</code>, <code>Promise.allSettled()</code>,
              <code>Promise.any()</code>, and <code>Promise.race()</code>, you
              can write cleaner and more efficient code. Mastering Promises will
              make your asynchronous tasks easier to manage and your
              applications more reliable. Keep experimenting and coding!
            </p>
          </div>
        </div>
        <Dock />
